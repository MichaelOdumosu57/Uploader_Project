			...
			.forEach((y: any, j) => {
				...
				if (parentZSymbol !== undefined) {
					...
					try{
						...
						console.group()
						console.error(parentZSymbol,zChildren[parentZSymbol])
						console.error(childZSymbol, zChildren[childZSymbol])
						console.error(e.message)
						console.error("the pareent does not yet exist in the DOM")
						console.groupEnd()
					}
